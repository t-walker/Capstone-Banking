...
const appRoutes: Routes = [
    ...
    {path: 'loan/review/:id', component: LoanReviewComponent, data: {title: 'Loan Approval'}},
    {path: 'loan/marketplace', component: MarketplaceListComponent, data: {title: 'Loan Market'}},
    {path: 'loan/marketplace/:id', component: MarketplaceItemComponent, data: {title: 'Loan Item'}},
